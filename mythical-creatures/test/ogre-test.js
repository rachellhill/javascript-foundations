...
describe('Ogre', () => {
  ...
  it('humans should only notice an ogre on the third encounter', () => {
    const ogre = new Ogre({name: 'Brak'});
    const human = new Human('Jane');
  ...
  it('ogre hits human every second time it swings', () => {
    ...
    ogre.encounter(human); // encounterCounter = 1, swings at 0
    ogre.encounter(human); // encounterCounter = 2, swings at 0
    ogre.encounter(human); // encounterCounter = 3, swings at 1
    ogre.encounter(human); // encounterCounter = 4, swings at 1
    ogre.encounter(human); // encounterCounter = 5, swings at 1
    ogre.encounter(human); // encounterCounter = 6, swings at 2
